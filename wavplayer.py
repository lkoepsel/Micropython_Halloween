...
#
# MicroPython Class used to control playing a WAV file using an I2S amplifier
...
class WavPlayer:
    ...
    def __init__(self, id, sck_pin, ws_pin, sd_pin, ibuf, root="/wav"):
        self.id = id
