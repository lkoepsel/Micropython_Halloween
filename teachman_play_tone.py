...
#
# - write audio samples containing a pure tone to an I2S amplifier
...
def make_tone(rate, bits, frequency):
    ...
    for i in range(samples_per_cycle):
        sample = range + int((range - 1)
                             * math.sin(2 * math.pi * i / samples_per_cycle))
...
# ======= I2S CONFIGURATION =======
SCK_PIN = 14    # Bit Clock Pico Pin 21
WS_PIN = 15     # Left/Right Clock Pico Pin 22
SD_PIN = 13     # Data In Pico Pin 24
I2S_ID = 0
...
samples = make_tone(SAMPLE_RATE_IN_HZ, SAMPLE_SIZE_IN_BITS,
